...
LOGIN_URL = '/login'
JAZZMIN_SETTINGS = {
    "site_title": "Shahbaz Glass House",
    "site_header": "your_site_header",
    "site_brand": "Shahbaz Glass Pattoki",
    "site_icon": "icones/shop-solid.jpg",
    # Add your own branding here
    "site_logo": None,
    "welcome_sign": "Welcome to the Shahbaz Glass House",
    # Copyright on the footer
    "copyright": "Shahbaz Glass House",
    "user_avatar": None,
    ############
    # Top Menu #
    ############
